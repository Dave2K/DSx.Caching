...
namespace DSx.Caching.Abstractions.Interfaces
{
    ...
    public interface ICacheProvider : IDisposable, IAsyncDisposable
    {
        ...
        Task<CacheOperationResult> ExistsAsync(string key, CancellationToken cancellationToken = default);
        ...
        Task<CacheOperationResult<T>> GetAsync<T>(string key, CacheEntryOptions? options = null, CancellationToken cancellationToken = default);
        ...
        Task<CacheEntryDescriptor?> GetDescriptorAsync(string key, CancellationToken cancellationToken = default);
        ...
        /// <param name="cancellationToken">Token di annullamento.</param>
        /// <returns>Risultato dell'operazione.</returns>
        Task<CacheOperationResult> SetAsync<T>(string key, T value, CacheEntryOptions? options = null, CancellationToken cancellationToken = default);
        ...
        /// <param name="cancellationToken">Token di annullamento.</param>
        /// <returns>Risultato dell'operazione.</returns>
        Task<CacheOperationResult> RemoveAsync(string key, CancellationToken cancellationToken = default);
        ...
        /// <param name="cancellationToken">Token di annullamento.</param>
        /// <returns>Risultato dell'operazione.</returns>
        Task<CacheOperationResult> ClearAllAsync(CancellationToken cancellationToken = default);
